...
<?php echo $this->Form->create('FormARecord');?>
	<fieldset>
		<legend><?php __('Edit Form A Record'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FormARecord.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FormARecord.id'))); ?></li>

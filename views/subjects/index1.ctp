<div class="subjects index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('sem');?></th>
			<th><?php echo $this->Paginator->sort('section');?></th>
			<th><?php echo $this->Paginator->sort('teacher1');?></th>
			<th><?php echo $this->Paginator->sort('teacher2');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $subject['Subject']['sem']; ?>&nbsp;</td>
		<td><?php echo $subject['Subject']['section']; ?>&nbsp;</td>
		<td><?php echo $subject['Subject']['teacher1']; ?>&nbsp;</td>
		<td><?php echo $subject['Subject']['teacher2']; ?>&nbsp;</td>
		<td class="actions">

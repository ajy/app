 ...
 */
	function display() {
		...
		//allows custom controller logic for views generated by pages controller
       ...
       function teacher() {
       		...
       		if(!$form_a_results && !$form_b_results)$this->Session->setFlash("No feedback has been received for your subjects");
       }
